        ...
        $formattedExamShifts = $availableExamShifts->map(function ($examShift) {
            return [
                ...
                'subjectgrade' => [
                    ...
                    'description' => $examShift->exam ? $examShift->exam->subjectGrade->Description : 'No description',
                    'duration' => $examShift->exam ? $examShift->exam->subjectGrade->Duration : 'No duration',
                    'totalQuestions' => $examShift->exam ? $examShift->exam->subjectGrade->TotalQuestions : 'No questions'
                ],
