...
Route::get('/exam-schedule/{accountId}', [ExamScheduleController::class, 'getCurrentExamShifts']);
...
Route::get('/tests/{accountId}', [Route::get('/tests/{id}', [TestController::class, 'show']);
::class, 'getCurrentExamShifts']);
