...
Route::prefix('exam-shifts')->group(function () {
    Route::get('/', [ExamShiftController::class, 'index']);
    Route::get('/{id}', [ExamShiftController::class, 'show']);
    Route::post('/', [ExamShiftController::class, 'store']);
    Route::put('/{id}', [ExamShiftController::class, 'update']);
    Route::delete('/{id}', [ExamShiftController::class, 'destroy']);
});
